...
<div style="clear: both">
		...
		<h5 style="float: right">
			...
			<form action="${pageContext.request.contextPath }/logout" method="post" class="form1">
				...
				<form action="handle-product" method="post">
					...
					<div class="form-group">
						<label for="name">Book Name</label> <input type="text"
							...
							. name="name" placeholder="Enter the book name here">
      ...
      %>
					...
					<div class="form-group">
						...
						<label for="date">Date</label> <input type="text"
							placeholder="Enter Product date" name="date"
							class="form-control" id="date" value="<%=dateToStr%>">
